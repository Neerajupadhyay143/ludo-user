...
function RegisterPage() {
    ...
    useEffect(() => {
        setIsGetOtpDisabled(
            ...
            (showEmailField && email && !isEmailVerified) || // Add this condition
            isPhoneNumberVerified ||
            isOtpFieldsShown
        );
    }, [name, phoneNumber, email, showEmailField, isPhoneNumberVerified, isOtpFieldsShown, isEmailVerified]);
...
//     // Store the access token in local storage or a cookie for later use
